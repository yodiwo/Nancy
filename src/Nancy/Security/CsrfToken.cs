namespace Nancy.Security
{
    ...
    public sealed class CsrfToken
    {
        ...
        /// </summary>
        private const string _DEFAULT_CSRF_KEY = "NCSRF";

        /// <summary>
        /// The key for the csrf cookie/form value/querystring value
        /// </summary>
        public static string DEFAULT_CSRF_KEY { get; private set; }

        /// <summary>
        /// Set key for the csrf cookie/form value/querystring value
        /// </summary>
        /// <param name="key"></param>
        public static void SetCSRFKey(string key)
        {
            // protection again null|empty|whitespace strings
            if (String.IsNullOrEmpty(key) || String.IsNullOrWhiteSpace(key))
                DEFAULT_CSRF_KEY = _DEFAULT_CSRF_KEY;
            else
                DEFAULT_CSRF_KEY = key;
        }
